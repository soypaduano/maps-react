export default { "objs": [
    ...
    },
    {
        ...
        name: "Radio Relativa",
        area: "Marqués de Vadillo",
        description: "Radio Relativa es una radio comunitaria, independiente y experimental  que sirve como plataforma para impulsar diferentes iniciativas culturales y musicales relacionadas con la ciudad de Madrid y más allá.Una radio que intenta visibilizar aquello que ocurre en los circuitos alejados de lo comercial, pero que sin embargo es imprescindible para comprender a toda una generación a partir de sus inquietudes artísticas. ",
        date: 2015,
        adminPick: true,
    ...
    },
    {
        id:"8",
        coord: {
            lat: 40.38792394642324,
            lon: -3.72070845781842
        },
        name: "D Gomez",
        area: "Pan Bendito & Carabanchel",
        description: `Dani Gómez, mejor conocido artísticamente como Kaidy Cain, es un rapero originario de Carabanchel, distrito de Madrid, España, nacido el 12 de febrero de 1990. Conocido por ser parte del grupo de trap "Pxxr Gvng"”, (después conocido como “Los Santos”), por su original estilo y las controversia que ha tenido con el artista español "C. Tangana". Es responsable de la explosión del género trap en España junto a su grupo PXXR GVNG o Los Santos.`,
        date: 2012,
        adminPick: true,
    ...
    },
    {
        id:"9",
        coord: {
            lat: 40.39187340548086,
            lon: -3.6586214439608145
        },
        name: "LDK (La Delgada Kru)",
        area: "Vallecas",
        description: "Formado por B Walls y Vela, grupo de rap clásico madrileño del barrio de Vallecas. Un álbum muy famoso suyo es Fenix.",
        date: 2014,
        adminPick: false,
    ...
    },
    {
        id:"10",
        coord: {
            lat: 40.63011465701798,
            lon: -4.006192248746887
        },
        name: "Gloosito",
        area: "Collado Villalba",
        description: "Gloosito (1996, Collado Villalba) es el aire fresco que necesitaba la escena urbana nacional.Junto a CTDS (Shynelevell, JayDime) ha liderado un nuevo sonido y estética que ha cautivado al público más exigente. Barras de peso sobre Detroit Beats y una cadencia adictiva han llevado al joven madrileño a presentar su música en Infierno, Costa Social Club, Chachá o Teledeporte (Madrid Urban Sports) y a colaborar con artistas como Kaydy Cain o Yung Beef",
        date: 2018,
        adminPick: false,
    ...
    },
    {
        ...
        area: "Vallecas",
        description: "Depresión Sonora es una propuesta independiente de post punk español que nació durante la pandemia. El confinamiento social y la incertidumbre que cubrían el mundo entero sirvieron como inspiración para Marcos Crespo, quien da vida a este proyecto.",
        date: 2020,
        adminPick: false,
    ...
    },
    {
        id:"12",
        coord: {
            lat: 40.448571242738964,
            lon: -3.608260049296632
        },
        name: "Hijos Bastardos",
        area: "Canillejas",
        description: `'Hijos bastardos es un grupo formado en Madrid capital, que nació en el año 2002. El grupo está compuesto por 4 personas: Nasta y Charliee como MCs, Rocca como productor, y Dj Bambú. Juntos han lanzado 3 trabajos: "Tardes de chili...", "Arte en el tatami" y "Por H y por B". Desde 2006 llevan sin sacar nada como grupo, aun así colaborando entre ellos en diferentes proyectos.'`,
        date: 2002,
        adminPick: false,
    ...
    },
    {
        id:"13",
        coord: {
            lat: 40.43225019203374,
            lon: -3.6097417137669474
        },
        name: "Dj Gostoso",
        area: "San Blas",
        description: `'Dj Gostoso es un DJ de la zona de San Blas'`,
        date: 2010,
        adminPick: false,
